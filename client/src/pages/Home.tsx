      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-gray-50 to-white py-20 md:py-32">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#2c3e50] hover:bg-[#1a1a1a]">
        ...
        <section id="blog" className="py-16 md:py-24 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { category: "SEO", title: "Future of SEO in the AI Era", desc: "Explore how artificial intelligence is reshaping search engine optimization strategies..." },
                { category: "AI Automation", title: "How AI Automation Improves Business Efficiency", desc: "Discover how intelligent automation can reduce costs and increase productivity..." },
                { category: "SEO", title: "SEO Basics for Startups", desc: "A practical guide to getting your startup visible in search results..." },
              ].map((article, i) => (
                <Card key={i} className="p-6 hover:shadow-lg transition-shadow">
                  ...
                  <button className="text-[#2c3e50] hover:text-[#1a1a1a] font-medium text-sm">Read More →</button>
                </Card>
              ))}
            </div>
